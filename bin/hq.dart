import 'package:hq/treasure_card.dart';

const List<TreasureCard> treasureDeck = [
  TreasureCard(
    title: "Gold!",
...
void main() {
  final deck = List.from(treasureDeck);
  deck.shuffle();

  print("DRAW: ${deck.first.title}\n${deck.first.description}");
}